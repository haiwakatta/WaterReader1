...
public class DeviceControlActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            intent.putExtra(Intent.EXTRA_STREAM, getImageUri(this, imageBitmap));
    ...
    private void displayData(String data) {
        if (data != null) {
            ...
            if(intValue < 500 && plantStatus) { //if plant needs water
                imageView.setBackgroundResource(R.drawable.animation_reverse);
                plantAnimation = (AnimationDrawable) imageView.getBackground();
                plantAnimation.start();
                textView.setText(R.string.water_me);
                plantStatus = !plantStatus;
            }
            if(intValue >= 500 && !plantStatus){ //if plant is fine
            ...
            else if(intValue >= 500 && plantStatus){
